            ...
            {items.map((item: SubMenuItem) => (
              <div key={item.label} className="submenu-item-wrapper">
                {item.path ? (
                  <Link
                    href={item.path}
                    className="sidebar-submenu-item submenu-item flex items-center gap-4"
                  >
                    ...
                    {item.children.map((child: SubMenuItem) =>
                      child.path ? (
                        <Link
                          key={child.label}
                          href={child.path}
                          className="sidebar-submenu-item submenu-item submenu-item-sub submenu-subitem flex items-center gap-3 text-gray-500"
                        >
