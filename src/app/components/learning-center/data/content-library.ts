...
export const QUICK_GUIDE_CATEGORIES: QuickGuideCategory[] = [
  {
    id: 'qg_start_selling',
    name: 'Start Selling',
    subtitle: 'Begin generating revenue for your business',
    description: 'Create quotations, invoices, and manage your sales process from initial contact to payment',
    icon: 'point_of_sale',
    order: 1,
    status: 'published',
    featureMapping: 'sell',
  ...
  {
    id: 'qg_buy_from_suppliers',
    name: 'Buy from Suppliers',
    subtitle: 'Manage your purchasing and vendor relationships',
    description: 'Track purchases, manage supplier relationships, and organize your procurement process',
    icon: 'shopping_cart',
    order: 2,
    status: 'published',
    featureMapping: 'buy',
  ...
  {
    id: 'qg_manage_expenses',
    name: 'Record Expenses',
    subtitle: 'Track and manage your business expenses',
    description: 'Record business expenses, categorize spending, and maintain accurate financial records',
    icon: 'receipt_long',
    order: 3,
    status: 'published',
    featureMapping: 'expenses',
    assignedTaskIds: [],
    assignedWorkflowIds: [],
    assignedGoalIds: [],
    version: 1,
  ...
  {
    id: 'qg_manage_inventory',
    name: 'Manage Your Products',
    subtitle: 'Organize your product catalog and inventory',
    description: 'Set up your product database, manage inventory levels, and track product performance',
    icon: 'inventory',
    order: 4,
    status: 'published',
    featureMapping: 'products',
    assignedTaskIds: [],
    assignedWorkflowIds: [],
    assignedGoalIds: [],
    version: 1,
  ...
  },
  {
    id: 'qg_add_contacts',
    name: 'Add Contacts',
    subtitle: 'Build your customer and supplier database',
    description: 'Add and manage your customer and supplier contacts for streamlined business operations',
    icon: 'contact_page',
    order: 5,
    status: 'published',
    featureMapping: 'contacts',
    assignedTaskIds: [],
    assignedWorkflowIds: [],
    assignedGoalIds: [],
    version: 1,
  ...
  },
  {
    id: 'qg_see_reports',
    name: 'See Reports',
    subtitle: 'Learn about your company performance',
    description: 'Generate and understand financial reports to gain insights into your business health',
    icon: 'assessment',
    order: 6,
    status: 'published',
    featureMapping: 'reports',
    assignedTaskIds: [],
    assignedWorkflowIds: [],
    assignedGoalIds: [],
    version: 1,
